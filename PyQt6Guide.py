"""
    ...
    ПРАКТИЧЕСКОЕ ПОСОБИЕ ПО ОСНОВНЫМ ЭЛЕМЕНТАМ ФРЕЙМВОРКА PYQT6
    ...
    Описание:
        ...
        крупных фреймворков, таких как PyQt6. Тем кто сталкивается с данным
...
from PyQt6.QtGui import QFont, QIcon, QAction, QStandardItem, QStandardItemModel
...
class BasicWindow(QMainWindow):
    def __init__(self):
        ...
        Описание:
            ...
            c графическим интерфейсом PyQt6, являясь пустым окном
...
class QHBoxLayoutExample(QMainWindow):
    def __init__(self):
        ...
        Описание
            ...
            на PyQt6. В данном приложении мы рассмотрим принцип работы одного из так
            ...
            PyQt6. Как можно понять из названия отличается от прочих макетов горизонтальным
...
class QVBoxLayoutExample(QMainWindow):
    """
        Описание
            ...
            на PyQt6. Демонстрирует принцип работы макета QVBoxLayout

            QVBoxLayout — является одним из макетов доступных в рамках фреймворка
            PyQt6. Антогоничен по функционалу макету QHBoxLayout, осуществляя позиционирование
...
class QGridLayoutExample(QMainWindow):
    """
        Описание
            ...
            на PyQt6. Предназначено для демонстрации использования макета QGridLayout
            
            QGridLayout — представляет собой один из макетов доступных в рамках фреймворка
            PyQt6. Используется для позиционирования виджетов внутри родительского виджета
...
class QFormLayoutExample(QMainWindow):
    """
        Описание
            ...
            на PyQt6. В данном приложении мы рассмотрим принцип работы одного из базовых
            макетов — QFormLayout 
            
            QFormLayout — является одним из макетов доступных в рамках фреймворка
            PyQt6. Как можно понять из названия представляет собой макет который
...
class WidgetList(QMainWindow):
    def __init__(self):
        ...
        Описание:
            ...
            на PyQt6, и служит для демонстрации основных виджетов из модуля
            ...
            объектов стоит привести их краткое описание:
                ...
                PyQt6 на фоне оригинальных графических API — Кроссплатформенность

                Модуль QtWidgets — является частью фреймворка PyQt6, служит для
                ...
                из важнейших частей графического фреймворка PyQt6
...
class QLabelWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала класса QLabel,
...
class QToolTipExample(QMainWindow):
    ...
    Описание
        ...
        на PyQt6. Служит для демонстрации возможностей метода setToolTip. Однако
        перед тем, как переходить к структуре класса QToolTipExample, стоит
        рассмотреть что из себя представляет ToolTip в парадигме фреймворка PyQt6.
...
class QLineEditWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, и служит для демонстрации базовых возможностей класса QLineEdit
        из модуля фрейморка PyQt6 — QWidgets. Перед тем как продемонстрировать
...
class QPushButtonWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QPushButton.
        Однако перед тем как переходить к структуре класса QPushButtonWidget стоит
        дать краткое определение виджету QPushButton.

        QPushButton — класс из модуля фреймворка PyQt6, QWidgets. Служит для
...
class QSpinBoxWidget(QMainWindow):
    ...
    на PyQt6, служит для демонстрации базового функционала виджета QSpinBox.
    ...
    QSpinBox — объект из модуля QWidgets фреймворка PyQt6. Сам виджет
...
class QCheckBoxWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QCheckBox.
        ...
        QCheckBox — класс из модуля QWidgets фреймворка PyQt6. Представляет
...
class QRadioButtonWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QRadioButton.
...
class QListWidgetExample(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QListWidget.
...
class QScrollBarWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QScrollBar.
...
class QComboBoxWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QComboBox.
...
class QSliderWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QSlider.
...
class QTimeEditWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QTimeEdit.
        ...
        QTimeEdit — класс модуля QWidgets, фреймворка PyQt6. В контексте
...
class QDateEditWidget(QMainWindow):
    ...
    Описание
        ...
        определение классу что непосредственно связан с ним
            ...
            QDateEdit — класс модуля QWidgets, фреймворка PyQt6. В контексте
            пользовательского интерфейса окна представляет собой поле ввода
...
class QDateTimeEditWidget(QMainWindow):
    ...
    Описание
        ...
        QDateTimeEdit — класс модуля QWidgets, фреймворка PyQt6. В контексте
...
class QCalendarWidgetExample(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QCalendarWidget.
...
class QProgressBarWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QProgressBarWidget.
...
class QFontComboBoxWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QFontComboBox.
...
class QTextEditWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QTextEdit.
        Перед тем как перейти к демонстрации функционала данного виджета
        стоит дать ему определение

        QTextEdit — класс модуля QWidgets фреймворка PyQt6. В рамках пользовательского
...
class QPlainTextEditWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QPlainTextEdit.
...
class QTextBrowserWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QTextBrowser.
...
class QStatusBarWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации основных функций виджета QStatusBar.
...
class QMultiDocumentApplication(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QMdiArea. Виджет
...
class QDockWidgetDemonstration(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QDockWidget.
...
class QToolBoxWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QToolBox.
...
class QLCDNumberWidget(QMainWindow):  
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QLCDNumber.
...
class QDialWidget(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QDial.
...
class QMenuBarExample(QMainWindow):
    ...
    Описание
        ...
        на PyQt6, служит для демонстрации базового функционала виджета QMenuBar.
...
class QDialogWidgets(QMainWindow):
    ...
    на PyQt6. Служит для демонстрации возможностей классов QFileDialog, 
    ...
    диалоговые окна
        ...
        в общем, и модуля QWidgets фреймворка PyQt6 в частности представляют собой
...
class QMessageBoxWidget(QMainWindow):
    ...
    Описание:
        ...
        на PyQt6. Служит для демонстрации возможностей класса QMessageBox, и отлично
...
class QSplitterWidget(QMainWindow):
    ...
    на PyQt6. Служит для демонстрации возможностей класса QSplitter. Сам
...
class QTabWidgetDemonstration(QTabWidget):
    ...
    Описание
        ...
        интерфейсом на PyQt6. Служит для демонстрации возможностей виджета
...
class QDragAndDropWidget(QMainWindow):
    ...
    Описание
        ...
        интерфейсом на PyQt6. Служит для демонстрации возможностей
...
class QTableViewWidget(QMainWindow):
    """
        ...
        интерфейсом на PyQt6. Служит для демонстрации функционала виджета
